...
export default function ServicesCategoryClient({
  ...
  const buildParams = useCallback(
    ...
    [category, filters, debouncedSearch],
  );
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      {/* Breadcrumb */}
      <nav className="flex items-center gap-2 text-sm text-theme-text mb-6">
        <Link href="/" className="hover:text-theme-heading">
          Home
        </Link>
        <ChevronRight size={16} />
        <Link href="/services" className="hover:text-theme-heading">
          Services
        </Link>
        <ChevronRight size={16} />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
        <div>
          ...
          <p className="text-theme-text">
            Find expert {category.toLowerCase()} professionals for your next
            project.
          </p>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1">
          {loading ? (
            ...
            <EmptyState
              icon={LayoutGrid}
              title={`No ${category.toLowerCase()} services found`}
